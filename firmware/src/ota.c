...
/* OTA v2, milestone M1-C: stage and validate the inactive slot, then require
 * two distinct confirmations before atomically switching boot markers. */
...
#define OTA_V2_RESPONSE_SIZE         28U
...
static void ota_v2_send_status(uint8_t command, uint8_t status)
{
    ...
    ota_v2_response[20] = OTA_V2_CAP_INSTALL;
