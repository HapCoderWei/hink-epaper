...
#define HINK_PANEL_HINK_E0213A162  1
#define HINK_PANEL_GDEY0213Z98     2

#ifndef HINK_PANEL_PROFILE
#define HINK_PANEL_PROFILE HINK_PANEL_HINK_E0213A162
#endif

#if HINK_PANEL_PROFILE != HINK_PANEL_HINK_E0213A162 && \
    HINK_PANEL_PROFILE != HINK_PANEL_GDEY0213Z98
#error "Unsupported HINK_PANEL_PROFILE"
#endif
